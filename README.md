...
(define-module projectile
  ...
  (defmacro projectile+-defun-in-project-root (func)
  ...
  (projectile+-defun-in-project-root ido-find-file)
  (projectile+-defun-in-project-root git-grep)
  (projectile+-defun-in-project-root shell-command)
  ...
  (define-key projectile-mode-map (kbd "M-s p G") 'git-grep-in-project-root)
  (define-key projectile-mode-map (kbd "M-s p !") 'shell-command-in-project-root)
